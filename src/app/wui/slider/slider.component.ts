 ...
 */
export const FL_SLIDER_VALUE_ACCESSOR: any = {
  provide: NG_VALUE_ACCESSOR,
  useExisting: forwardRef(() => FlSlider),
  multi: true
};

/** A simple change event emitted by the FlSlider component. */
export class FlSliderChange {
  /** The FlSlider that changed. */
  source: FlSlider;
...
@Component({
  selector: 'fl-slider',
  providers: [ FL_SLIDER_VALUE_ACCESSOR ],
  host: {
    '(focus)': '_onFocus()',
    '(blur)': '_onBlur()',
    ...
    '[class.fl-slider-disabled]': 'disabled',
    '[class.fl-slider-has-ticks]': 'tickInterval',
    '[class.fl-slider-horizontal]': '!vertical',
    '[class.fl-slider-axis-inverted]': '_invertAxis',
    '[class.fl-slider-sliding]': '_isSliding',
    '[class.fl-slider-thumb-label-showing]': 'thumbLabel',
    '[class.fl-slider-vertical]': 'vertical',
    '[class.fl-slider-min-value]': '_isMinValue',
    '[class.fl-slider-hide-last-tick]': 'disabled || _isMinValue && _thumbGap && _invertAxis',
  },
...
export class FlSlider extends _MdSliderMixinBase
  ...
  @Output() change = new EventEmitter<FlSliderChange>();

  /** Event emitted when the slider thumb moves. */
  @Output() input = new EventEmitter<FlSliderChange>();
